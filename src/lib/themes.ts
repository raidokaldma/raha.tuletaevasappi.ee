...
export const themes: Theme[] = [
	...
	},
	{
		...
		tableWrapper: 'border-neutral-800 bg-neutral-900',
		thead: 'bg-neutral-800/60 backdrop-blur-md shadow-[0_1px_0_0_rgb(38,38,38)]',
		th: 'text-amber-300/80',
		row: 'hover:bg-neutral-800/50',
		rowBorder: 'border-neutral-800',
		input: 'border-neutral-700 bg-neutral-800 text-amber-100 placeholder:text-neutral-600 focus:border-amber-500',
		euro: 'text-neutral-500',
		pillOn: 'border border-amber-500 bg-amber-950 text-amber-300 ring-1 ring-amber-500',
		pillOff: 'border border-neutral-700 bg-neutral-800 text-neutral-500',
		deleteBtn: 'text-red-400 hover:bg-red-950/40 hover:text-red-300',
		emptyText: 'text-neutral-600',
		tfoot: 'border-neutral-800 bg-neutral-800/60 backdrop-blur-md',
		tfootLabel: 'text-amber-300/80',
		tfootValue: 'text-amber-100',
		card: 'border-neutral-800 bg-neutral-900',
		cardLabel: 'text-neutral-500',
		cardFieldLabel: 'text-neutral-400',
		totalBar: 'border-neutral-800 bg-neutral-800',
		totalLabel: 'text-amber-300/80',
		totalValue: 'text-amber-100',
		addBtn: 'bg-amber-600 text-white hover:bg-amber-500',
		summaryCard: 'border-neutral-800 bg-neutral-900',
		summaryName: 'text-amber-100',
		summaryLabel: 'text-neutral-500',
		summaryValue: 'text-neutral-300',
		summaryPositive: 'text-green-400',
		summaryNegative: 'text-red-400',
		summaryDivider: 'border-neutral-800',
		settlementCard: 'border-neutral-800 bg-neutral-900',
		settlementFrom: 'text-amber-100',
		settlementArrow: 'text-neutral-600',
		settlementTo: 'text-amber-100',
		settlementAmount: 'text-amber-300 bg-amber-950/60',
		rowInvalid: 'bg-red-950/30!',
		focusRing: 'focus:ring-amber-500',
		themeBtn: 'border-neutral-700 bg-neutral-900 text-amber-200/80 hover:bg-neutral-800',
		themeBtnActive: 'border-amber-500 bg-amber-950/40 text-amber-300 ring-1 ring-amber-500',
		menuDropdown: 'bg-neutral-900 ring-1 ring-white/10 shadow-lg',
		menuItem: 'text-neutral-300 hover:bg-neutral-800 hover:text-amber-100',
		menuItemActive: 'bg-neutral-800 text-amber-100'
	}
];
